...
Module Program
    ...
    Public Sub Main()
        System.Console.WriteLine("entre al main")
        ...
        Dim datosAd As DatosAdicionalesData = New DatosAdicionalesData()
        Dim dataAlgo As HashSet(Of DataItem) = New HashSet(Of DataItem)()
        Dim dataItem As DataItem = New DataItem()
        dataItem.id = 0
        ...
        Console.WriteLine("El decifrado es: " & r.amount & " " & r.response)
    End Sub
End Module
